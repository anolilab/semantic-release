 ...
 *
 * @param {string} cwd                     – Working directory from which to derive the default path.
 * @param {NodeJS.ProcessEnv} environment  – Environment variables (typically `context.env`).
 *
 * @returns {string} Absolute path to the `.npmrc` file that should be used/written.
 */
