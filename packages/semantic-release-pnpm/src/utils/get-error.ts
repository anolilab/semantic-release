 ...
 *
 * @param {T}               code     – Error code referencing a predefined error factory.
 * @param {ErrorContext}    [context={}] – Optional values injected into the error message template.
 *
 * @returns {SemanticReleaseError} Fully initialised semantic-release error instance.
 */
