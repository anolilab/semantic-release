 ...
 *
 * @param {string | null | undefined} channel – The channel coming from `context.nextRelease.channel`.
 *
 * @returns {string} The npm dist-tag that should be used for the publish operation.
 */
